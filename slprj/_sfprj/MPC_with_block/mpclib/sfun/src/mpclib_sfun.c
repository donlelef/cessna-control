  ...
  if (nrhs>2 && mxIsChar(prhs[1])) {
    ...
    if (!strcmp(commandName,"library")) {
      ...
      if (!strcmp(machineName,"mpclib")) {
        if (nrhs==3) {
          ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(1216633100U);
          ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(1198829382U);
          ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(19600023U);
          ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(3918352354U);
        } else if (nrhs==4) {
  ...
  nrhs, const mxArray * prhs[] )
{
...

  {
    ...
    switch (chartFileNumber) {
     case 3:
      {
        if (strcmp(aiChksum, "6YvAwqbCBUHdcRRtLLvK0D") == 0) {
  ...
  nrhs, const mxArray * prhs[] )
{
...

  {
    ...
    switch (chartFileNumber) {
     case 3:
      {
        if (strcmp(tpChksum, "GyUuAR3emf2DR7coHzYikE") == 0) {
...
unsigned int sf_mpclib_jit_fallback_info( int nlhs, mxArray * plhs[], int nrhs,
  const mxArray * prhs[] )
{
  char commandName[64];
  char tpChksum[64];
...

  {
    ...
    switch (chartFileNumber) {
     case 3:
      {
        if (strcmp(tpChksum, "GyUuAR3emf2DR7coHzYikE") == 0) {
          extern mxArray *sf_c3_mpclib_jit_fallback_info(void);
          plhs[0] = sf_c3_mpclib_jit_fallback_info();
          break;
        }
      }
...
void sf_mpclib_get_post_codegen_info( int nlhs, mxArray * plhs[], int nrhs,
  const mxArray * prhs[] )
{
  ...
  switch (chartFileNumber) {
   case 3:
    {
      if (strcmp(tpChksum, "GyUuAR3emf2DR7coHzYikE") == 0) {
        extern mxArray *sf_c3_mpclib_get_post_codegen_info(void);
        plhs[0] = sf_c3_mpclib_get_post_codegen_info();
        return;
      }
    }
    break;
